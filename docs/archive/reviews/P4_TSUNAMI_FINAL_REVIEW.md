...
> 2026-09-13 배경 수정: 아래 P4 승인 기록은 당시 구현의 이력입니다. 현재 플레이 배경 3종은 선택 썸네일을 참조한 풀컬러 동화풍으로 교체했습니다. 원본·현재 후처리·프롬프트는 `assets/_source/tsunami/storybook/README.md`, 실제 화면은 `references/tsunami-storybook-runtime.png`에서 확인합니다. 대피처·파도·경고·지형과 플레이 규칙은 기존대로 유지합니다.
