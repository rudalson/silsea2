...
> 2026-09-13 배경 갱신: 아래 내용은 최초 P5 승인 당시 기록입니다. 현재 배경은 [동화풍 원본·프롬프트](../assets/_source/submerged/storybook/README.md)를 사용합니다. 실제 적용 화면은 [짧은 잠수 구간](submerged-storybook-runtime.png)과 [긴 잠수 구간](submerged-storybook-long-runtime.png)에서 확인할 수 있습니다. 지형·수영·호흡 규칙은 유지합니다.

> 상태: 사용자 최종 승인 완료 — 2026-08-28
...
최종 게이트는 2026-08-28 사용자의 `P5 최종 승인`으로 통과했다. 최종 에셋 통합은 `28997c9`, 수중 오디오와 전환 회귀 보완은 `6f7e571`에 반영했다.
