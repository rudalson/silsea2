...
| 공용 팔레트 HEX 사람 확인 | 승인 대기 |
| 실세아 기본형 무뿔 확인 | 완료 — 2026-08-03 사용자 승인 |
| 두 캐릭터 Locked Description·비율 확인 | 승인 대기 |
| 레벨 스키마 확인 | 승인 대기 |
| Phase 0 문서 정합성 검사 | 진행 중 |
...
- [ ] 유니콘 자석과 가시 호박 파괴
- [ ] 페가수스 10초 비행, 3초 지상 회복, 활공 전환
- [ ] 알리콘 12초 피버, 종료 3초 예고, 안전 착지
- [ ] 별·퍼센트·콤보·카운트업 점수
- [ ] HP·피격·2초 무적·체크포인트 부활·완화된 점수 손실
- [ ] 데굴데굴 생감자·가시 호박·먹구름·까치 행동과 예고
- [ ] 까치 점수 절도와 회수 아이템
- [ ] 보스 section과 HP 3·3단계·약점·게이트
- [ ] 화면 밖 공격 비활성화
- [ ] `defeat_boss`, `reach_gate`, `collect_stars` handler
- [ ] 첫 60초 스크립트와 전체 텐션 비트 구현
- [ ] 고정 Seed 랜덤 테스트
- [ ] Object Pool로 탄환·파티클 누적 방지
