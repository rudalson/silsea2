...
export const BOSS_DEFINITIONS = Object.freeze({
  ...
  water_king: Object.freeze({
    ...
    completion: "level",
    animationRoles: Object.freeze(["idle", "submerge", "emerge", "attack", "dizzy", "hurt", "defeated"]),
    spawn: Object.freeze({ edgeOffset: 560 }),
    render: freezeRender({
      placeholderColor: COLORS.collectBlue,
      art: {
  ...
  random_king: Object.freeze({
    ...
    completion: "level",
    animationRoles: Object.freeze(["idle", "draw", "teleport", "attack", "taunt", "vulnerable", "hurt", "defeated"]),
    spawn: Object.freeze({ edgeOffset: 560 }),
    render: freezeRender({
      placeholderColor: COLORS.collectPink,
      art: {
