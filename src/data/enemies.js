...
export const ENEMY_DEFINITIONS = Object.freeze({
  ...
  dark_cloud: { behavior: "telegraph_lightning", params: ["triggerX"], color: toNumber(PALETTE.danger[1]) },
  magpie: { behavior: "telegraph_dive", params: ["triggerX"], color: toNumber(PALETTE.outline) },
