...
// Rebuild from original full-color artwork. Palette substitution on exported
// pixels would merge rainbow bands and bring back muddy foliage outlines.
if (!process.argv.includes("--legacy-palette-regrade")) {
