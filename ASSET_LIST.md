...
> 확장 P0 승인 · 2026-08-25 / 현재 상태: P2·P3 최종 에셋 사용자 승인 완료, P4 흑백 아트 앵커 승인 완료·최종 에셋 제작 준비
...
- P4 쓰나미 마을은 2026-08-26 역방향 코스·대피처·파도 타이밍 회색 상자를 승인하고 `50b8ecb`로 커밋했다. 오른쪽 파도·둔덕·열린 집·계단 고지대의 흑백 앵커와 컬러 적용안도 `P4 앵커 승인`으로 잠갔으며, 아래 P4 전용 에셋 제작과 연결을 진행한다.
