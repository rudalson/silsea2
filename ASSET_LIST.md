...
> 확장 P0 승인 · 2026-08-25 / 현재 상태: P2·P3·P4 최종 승인 완료, P5 최종 에셋 제작·통합 완료·사용자 최종 확인 중
...
| 키 | 우선 | 프레임 | 제작 게이트 |
|---|---|---:|---|
| `silsea_swim`, `silsea_unicorn_swim` | M | 각 6 | 제작·등록 완료, P5 최종 확인 중 |
| `potato89_swim`, `potato89_unicorn_swim` | M | 각 6 | 제작·등록 완료, P5 최종 확인 중 |
...
- P5 물에 잠긴 마을은 코스·흑백 앵커를 승인·커밋했다. 전용 배경 3레이어·선택 카드·64px 타일·수면/빛결/기포·두 캐릭터 기본/유니콘 수영 시트를 제작·등록했고 최종 화면 사용자 확인 중이다.
...
| `submerged_village_tileset` | M | 침수 집·수면·바닥 64px 지형 | 제작·등록 완료, 최종 확인 중 |
| `fx_water_surface` | M | 실제 회복 경계를 보여주는 수면 | 제작·등록 완료, 최종 확인 중 |
| `fx_water_caustics` | M | 물속 빛결 | 제작·등록 완료, 최종 확인 중 |
| `fx_bubble` | M | 수중 이동 기포 | 제작·등록 완료, 최종 확인 중 |
