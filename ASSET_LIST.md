...
> 확장 P0 승인 · 2026-08-25 / 현재 상태: P2·P3·P4·P5 최종 승인 완료 · P6 아트 앵커 승인·최종 제작 중
...
| `silsea_wing_guard` | S | 4 | 흑백 3키 자세·팔레트 승인 완료, 최종 제작 중 |
| `potato89_wing_guard` | S | 4 | 흑백 3키 자세·팔레트 승인 완료, 최종 제작 중 |
...
| 키 | 우선 | 구성 | 상태 |
|---|---|---|---|
| `potato_archer` | S | idle 2, aim 3, shoot 3, defeated 4 | 흑백 4키·팔레트 승인 완료, 최종 제작 중 |
| `projectile_arrow` | S | 화살 1종, 런타임 회전 | 흑백 형태·팔레트 승인 완료, 최종 제작 중 |
| `laser_emitter` | S | 레이저 발사기 1종 | 흑백 달·별 형태·팔레트 승인 완료, 최종 제작 중 |
| `laser_switch_on` | S | 켜진 스위치 | 돌출·완전한 별 형태·팔레트 승인 완료, 최종 제작 중 |
| `laser_switch_off` | S | 꺼진 스위치 | 함몰·갈라진 별 형태·팔레트 승인 완료, 최종 제작 중 |
| `fx_laser_beam` | S | 반복 빔 | 굵은 이중 외곽·팔레트 승인 완료, 최종 제작 중 |
| `fx_laser_warning` | S | 발사 예고 | 점선 형태·팔레트 승인 완료, 최종 제작 중 |
