...
> 확장 P0 승인 · 2026-08-25 / 현재 상태: P2·P3 최종 에셋 사용자 승인 완료, P4 코스 승인 완료·흑백 아트 앵커 준비
...
- P4 쓰나미 마을은 2026-08-26 역방향 코스·대피처·파도 타이밍 회색 상자를 승인했다. 현재 `grass_tileset`, 무지개 언덕 배경, `bgm_field` 재사용은 코스 확인 전용이며, 아래 P4 전용 에셋은 흑백 앵커 승인 뒤 제작한다.
